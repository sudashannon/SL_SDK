...
{
  // Name    ,PORT , PIN ,                        Init
  {LED_0 ,GPIOE,GPIO_Pin_1,RCC_AHB1Periph_GPIOE,LED_OFF},   // PD2,LED0
  {LED_1 ,GPIOE,GPIO_Pin_4,RCC_AHB1Periph_GPIOE,LED_OFF},   // PD2,LED0
  {LED_2 ,GPIOG,GPIO_Pin_9,RCC_AHB1Periph_GPIOG,LED_OFF},   // PD2,LED0
};
//--------------------------------------------------------------
// LED ausschalten
//--------------------------------------------------------------
