...
// From App Note.
    ...
    {COM8,          0xf0},
    {COM4,          SENSOR_OV7725_PLL_CONFIG}, // {COM4, 0x41},
    {COM6,          0xc5},
    {COM9,          0x11},
    {BDBASE,        0x7f},
    {BDSTEP,        0x03},
    ...
    {DM_LNL,        0x00},
    {BDBASE,        SENSOR_OV7725_BANDING}, // {BDBASE, 0x7f}
    {BDSTEP,        0x03},
...
static int get_exposure_us(sensor_t *sensor, int *exposure_us)
{
    ...
    *exposure_us = (((aec_h<<8)+(aec_l<<0))*t_line*t_pclk)/(((SENSOR_XCLK_FREQUENCY/clk_rc)*pll_mult)/1000000);
...
static int get_rgb_gain_db(sensor_t *sensor, float *r_gain_db, float *g_gain_db, float *b_gain_db)
{
    ...
    *r_gain_db = 20.0 * (log(red / gain_div) / log(10.0));
    *g_gain_db = 20.0 * (log(green / gain_div) / log(10.0));
    *b_gain_db = 20.0 * (log(blue / gain_div) / log(10.0));
