#include "Board_RC522.h"
#include "Board_SPI.h"
#include "APP_SoftTimer.h"
void RC_Delay(uint32_t ns)
{
  uint32_t i;
  for(i=0;i<ns;i++)
  {
...
void InitRc522(void)
{
  Board_SPIInit();//引脚可以修改
  PcdReset();
  PcdAntennaOff();
  APP_SoftTimer_DelayMS(2);  
  PcdAntennaOn();
...
u8 ReadRawRC(u8   Address)
{
	...
	Board_SPIWrite8bit(ucAddr);
	ucResult=Board_SPIRead8bit();
	SET_SPI_CS;
   return ucResult;
}
