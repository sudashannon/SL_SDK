...
typedef struct _sensor {
    ...
    int  (*read_byte)           (sensor_t *sensor, uint8_t slv_addr, uint8_t reg_addr, uint8_t *reg_data);
    int  (*write_byte)          (sensor_t *sensor, uint8_t slv_addr, uint8_t reg_addr, uint8_t reg_data);
...
int sensor_snapshot(sensor_t *sensor, uint8_t **image, uint32_t timeout_ms);
