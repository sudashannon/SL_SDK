...
void lv_anim_init(void)
{
    ...
    lv_task_create("GUIAnim",anim_task, LV_AINIM_TIME_PERIOD, LV_TASK_PRIO_MID, NULL);
}
...
int32_t lv_anim_path_ease_in(const lv_anim_t * a)
{
    ...
    int32_t step = MATH_Bezier3(t, 0, 1, 1, 1024);
...
int32_t lv_anim_path_ease_out(const lv_anim_t * a)
{
    ...
    int32_t step = MATH_Bezier3(t, 0, 1023, 1023, 1024);
...
int32_t lv_anim_path_ease_in_out(const lv_anim_t * a)
{
    ...
    int32_t step = MATH_Bezier3(t, 0, 100, 924, 1024);
...
int32_t lv_anim_path_overshoot(const lv_anim_t * a)
{
    ...
    int32_t step = MATH_Bezier3(t, 0, 600, 1300, 1024);
...
int32_t lv_anim_path_bounce(const lv_anim_t * a)
{
    ...
    int32_t step = MATH_Bezier3(t, 1024, 1024, 800, 0);
