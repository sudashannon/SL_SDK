 ...
 * @brief   标准输出printf实现。
 * @version 2.0 2019/06/07
 * @History 1.0 创建，修改自tivaware
		    1.1 增加了操作系统环境下的互斥锁
		    1.2 优化互斥锁逻辑
		    2.0 基于Marco Paland (info@paland.com)的版本重新修改
 ******************************************************************************
 */
...
#include <stdint.h>
///////////////////////////////////////////////////////////////////////////////
static printf_t PrintfHandle = {0};
...
static inline void _out_char(char character, void* buffer, size_t idx, size_t maxlen)
{
  ...
  if (character) {
	  if(PrintfHandle.putchar)
		PrintfHandle.putchar(character);
  }
}
...
#if PRINTF_SUPPORT_EXPONENTIAL == 1
...
void Printf_Init(void)
{
	...
	PrintfHandle.mutexid = osMutexNew(&MutexIDStdioAttr);
	#endif
}
