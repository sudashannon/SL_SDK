...
*************************************************/
static RTE_Shell_Err_e RTE_Shell_RR_Demon(int argc, char *argv[])
{
...
void RTE_RoundRobin_Init(void)
{
	...
	Memory_Alloc0(BANK_RTE,sizeof(RTE_RoundRobin_TimerGroup_t)*ROUNDROBIN_MAX_GROUP_NUM);
#if RTE_USE_OS == 0
	...
	RTE_Shell_AddCommand("timer","demon",RTE_Shell_RR_Demon,"Demon all running timers Example:timer.demon");
#endif // RTE_USE_SHELL
}
/*************************************************
*** Args:   NULL
