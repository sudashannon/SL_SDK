...
#if LV_MEM_CUSTOM == 0
#define LV_MEM_SIZE    (0x10000)        /*Size memory used by `lv_mem_alloc` in bytes (>= 2kB)*/
#define LV_MEM_ATTR                         /*Complier prefix for big array declaration*/
#define LV_MEM_AUTO_DEFRAG  1               /*Automatically defrag on free*/
#else       /*LV_MEM_CUSTOM*/
#define LV_MEM_CUSTOM_INCLUDE <bget.h>   /*Header for the dynamic memory function*/
#define LV_MEM_CUSTOM_ALLOC   bget       /*Wrapper to malloc*/
#define LV_MEM_CUSTOM_FREE    brel         /*Wrapper to free*/
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_VDB_SIZE         (25 * LV_HOR_RES)  /*Size of VDB in pixel count (1/10 screen size is good for first)*/
